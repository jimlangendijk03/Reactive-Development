...
# Repository-relative defaults. Override these constants when using a different
# data location. Keeping data outside Git is recommended because the OSV archive
# and generated caches can be large.
...
OSV_PATH = str(DATA_DIR / "osv" / "all.zip")
...
RELEASE_CACHE_PATH = str(DATA_DIR / "cache" / "release_cache.json")
...
VULN_CACHE_PATH = str(DATA_DIR / "cache" / "vulnerability_cache.json")
